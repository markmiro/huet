...
export default function Themer({ children, themes, initialThemeKey }) {
  ...
  return (
    <div
      style={{
        backgroundColor: huet.relativeColor(ctx, ctx.ramps.gray, 0),
        height: "100%"
      }}
    >
      ...
      <ThemeContext.Provider value={themerContext}>
        <div
          ...
          style={{
            outlineColor: huet.relativeColor(
              themerContext,
              themerContext.ramps.gray,
              0,
              0.2
            ),
            outlineOffset: -1,
            outlineWidth: 1,
            outlineStyle: "solid",
            boxShadow: `0 5px 30px #00000066`,
            backgroundColor: huet.relativeColor(
              themerContext,
              themerContext.ramps.gray,
              0
            ),
        ...
        >
          ...
          {!isOpen && (
            <button
              className="w-100 pa2 b"
              style={{
                borderColor: huet.relativeColor(
                  themerContext,
                  themerContext.ramps.gray,
                  10
                ),
                color: huet.relativeColor(
                  themerContext,
                  themerContext.ramps.gray,
                  100
                )
