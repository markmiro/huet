...
var styled = _interopDefault(require('styled-components/dist/styled-components.cjs'));
...
function useBrowserState(defaultValue) {
  ...
  var debounceSaveToLocalStorage = React.useCallback(_.debounce(function (key, value) {
